...
if ('d2u_stellenmarkt' == rex_request('import', 'string') && $old_tables_available) {
    ...
    echo '<h2>Import aus Redaxo 4 D2U Stellenmarkt Addon</h2>';
    echo '<p>Es wurden die D2U Stellenmarkt Addon Tabellen aus Redaxo 4 in der Datenbank gefunden.'
    ...
    echo '<a href="'. rex_url::currentBackendPage(['import' => 'd2u_stellenmarkt'], false) .'"><button class="btn btn-save">Import und vorhandene Daten löschen</button></a>';
    echo '</fieldset>';
}
...
<p>1.2.5:</p>
<ul>
	<li>hr4you_import Plugin: Bugfix für Pfadrechte.</li>
</ul>
<p>1.2.4:</p>
<ul>
